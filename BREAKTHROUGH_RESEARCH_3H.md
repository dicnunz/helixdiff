...
3. report oracle-in-lattice, prior top-k coverage, raw-verifier accuracy, anchor accuracy, margin activation, selected accuracy, and failure category per case.
